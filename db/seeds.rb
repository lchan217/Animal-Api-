Animal.create(name: "Bamboo", status: "Endangered", img: "https://images.unsplash.com/photo-1527118732049-c88155f2107c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60", category:"panda", health: 0)
...
Animal.create(name: "Spike", status: "Endangered", img: "https://images.unsplash.com/flagged/photo-1557650454-65194af63bf9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60", category:"rhino", health: 0)
Animal.create(name: "Congo", status: "Endangered", img: "https://images.unsplash.com/photo-1546922221-0716fb355664?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60", category:"gorilla", health: 0)
Animal.create(name: "Pouch", status: "Endangered", img: "https://images.unsplash.com/photo-1551270988-87c5ea57cdfe?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60", category:"kangaroo", health: 0)
Animal.create(name: "Stanley", status: "Endangered", img: "https://images.unsplash.com/photo-1551336568-e1e91d5ef65c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60", category:"bear", health: 0)
...
User.create(name: "Lizzie", age: 25, occupation: "teacher", score: 25, success: true)
User.create(name: "Andy", age: 23, occupation: "funemployed", score: 32, success: true)
User.create(name: "Connie", age: 22, occupation: "student", score: 45, success: true)
User.create(name: "Claire", age: 9, occupation: "student", score: 26, success: true)
User.create(name: "Sarah", age: 14, occupation: "student", score: 17, success: true)
User.create(name: "Mike", age: 79, occupation: "retired", score: 34, success: true)
User.create(name: "Eric", age: 81, occupation: "retired", score: 29, success: true)
